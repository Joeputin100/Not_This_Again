...
const LIGHTING_PRESETS := {
	"daylight": {
		...
		"sun_corona_color": Color(1.00, 0.86, 0.55, 1),
		"sun_corona_strength": 0.70,
		"moon_visible":  false,
	},
	"sunset": {
		...
		"sun_corona_color": Color(1.00, 0.55, 0.25, 1),
		"sun_corona_strength": 1.10,
		"moon_visible":  false,
	},
	"moonlight": {
	...
	"overcast": {
		...
		"sun_corona_color": Color(0.90, 0.92, 0.95, 1),
		"sun_corona_strength": 0.35,
		"moon_visible":  false,
	},
}

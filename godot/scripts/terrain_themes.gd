...
const TERRAIN_THEMES: Dictionary = {
	...
	"mine": {
		...
		"scatter": [
			...
			{"slug": "mine_portal", "density": 0.12, "scale": [1.4, 1.8],
	},
	"farm": {
		...
		"scatter": [
			...
			{"slug": "windmill_lolly", "density": 0.15, "scale": [1.5, 2.0],
	},
	"mountain": {
		...
		"scatter": [
			...
			{"slug": "pine_tree", "density": 0.5, "scale": [1.0, 2.0],
	},
	"vineyard": {   # L5 (was "vineyard"): Raisin Kidd's vine country. Textures still the
		...
		"boardwalk": null, "cliff": null,
		"scatter": [
			{"slug": "vine_trellis_clay", "density": 0.65, "scale": [0.9, 1.3],
	},
	"canyon": {
		...
		"scatter": [
			...
			{"slug": "cactus_saguaro", "density": 0.3, "scale": [0.9, 1.5],
	},
}
